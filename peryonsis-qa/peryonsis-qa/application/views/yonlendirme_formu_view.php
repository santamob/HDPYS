        ...
        <div> 
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <?php
                        foreach($pot_degerlendirme_data["buttons"] as $key=>$button){
                    ?>
                        <th><?php echo $button["button_name"];?></th>
                    <?php
                        }
                ?>
                ...
                <tr>
                    <td>
                        ...
                        if ($pot_varmi == 1)
                        {
                            ...
                            if ($pot_puan > 0)
                            {
                                ...
                                //echo  $pot_degerlendirme_data["name"]." -- ".$pot_puan;
                                //26.12.2023
                                echo $PotansiyelFormSonucu["level_text"]." -- ".$PotansiyelFormSonucu["point"];
                    ...
                    if (($who == 'yon1') && $degisiklik)
                    {
                        ...
                        foreach($pot_degerlendirme_data["buttons"] as $key=>$button){
                            //echo $button["button_state"];
                            $disabled = ($button["button_state"] == '1') ? "": "disabled";
                            
                            if ($pot_varmi == 1) // bu kısmı soru
                            {
                                ?>
                                <td>
                                    <input type="radio" name="hp" value="<?php echo  $key+1;?> " <?=($hp == $key+1)?'checked':''?> <?=$disabled?> required/>
                                </td>
                                <?
