...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div id="tabs" class="mt-3">
        <ul>
          <li><a href="#tabs-1" class="first-segment" id="kaf">Kendime Ait Formlar</a></li>
          <li><a href="#tabs-2" class="first-segment" id="aaf">Astlarıma Ait Formlar</a></li>
          <li><a href="#tabs-3" class="first-segment" id="aaaf"> Astlarımın Astlarına Ait Formlar</a></li>
        </ul>
        <div id='tabs-1'>
            <div id='tabs1'>
                <?
                                    ...
                                    <tbody>
                                        ...
                                        if ($onaya_gonder[$key])
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?
                                                    if ($od_ast_kontrol[$key] == 2 && $donem == 3)
                                                    {
                                                        echo "Onaya gönderebilmeniz için tüm değerlendirmeleri tamamlamalısınız.";
                                                    }
                                                    else if ($od_ast_kontrol[$key] == 3 && $donem == 3)
                                                    {
                                                        echo "Onaya gönderebilmeniz için öncesinde astlarınızın formlarına onay vermelisiniz.";
                                                    }
                                                    else
                                                    {
                                                        if($button_activity_for_confirmation):
                                                            echo $od_ast[$key]['onay_text'];    
                                                            else: ?>
                                                                Onay İşlemi bulunmamaktadır. Değerlendirmeler otomatik olarak bir üst yöneticiye gitmektedir.
                                                        ...
                                                        if ($od_ast[$key]['onay_durum'] == 2 || $od_ast[$key]['onay_durum'] == 3)
                                                        {
                                                            ...
                                                            <form method="POST" action="<?=base_url()?>d_donemleri/onay_islemleri">
                                                                ...
                                                                <?php if($button_activity_for_confirmation): ?>
...
<script>
    ...
    $(document).ready(function(){
            ...
            [
                {
                    id : 1,
                    js_id: "kaf",
                    category_name : "Kendime Ait Formlar",
                    items: [
                        {
                            item : "Hedef Formları"
                        },
                        {
                            item : "Yetkinlik Formları"
                        },
                        {
                            item : "Sonuç"
                        }
                ...
                },
                {
                    id : 2,
                    js_id: "aaf",
                    category_name : "Astlarıma Ait Formlar",
                    items: [
                        {
                            item : "Hedef Formları"
                        },
                        ...
                        {
                            item : "Potansiyel Formları"
                        },
                        {
                            item : "Görüşme Formları"
                        },
                        {
                            item : "Yölendirme Formları"
                        },
                        {
                            item : "Sonuç"
                        }
                ...
                },
                {
                    id : 3,
                    js_id: "aaaf",
                    category_name : "Astlarımın Astlarına Ait Formlar",
                    items: [
                        {
                            item : "Hedef Formları"
                        },
        ...
        $(".first-segment").on('click',function(){

            console.log(this.id);

            FormCategories.each(data, function (){
