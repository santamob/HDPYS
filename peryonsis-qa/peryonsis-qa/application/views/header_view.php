...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <a class="navbar-brand" href="<?=base_url()?>"><img src="<?=base_url()?>assets/img/logo.png" width="160"></a>
          ...
          if ($this->session->userdata('pernr') == 101993 || $this->session->userdata('pernr') == 101081 || $this->session->userdata('pernr') == 100003 || $this->session->userdata('pernr') == 102576 )
          {
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="IK Yönetim Paneli">
                ...
                <ul class="sidenav-second-level collapse" id="collapseExamplePages1">
                  <li>
                    <a href="<?=base_url()?>d_donemleri/yeni_kademelendirme">Yeni Kademelendirmeleri Oluştur</a>
                    <a href="<?=base_url()?>d_donemleri/havuz_kademelendirme_atama">Havuza Kademelendirmeleri Ata</a>
                    <a href="<?=base_url()?>d_donemleri/kademelendirme_yonetim_onay">Kademelendirme Yönetim Onayı</a>
                    <a href="<?=base_url()?>ikyp/form_tipleri/">Form Tipleri</a>
                    <a href="<?=base_url()?>ikyp/gostergelerv2/">Göstergeler</a>
                    <!--<a href="<?=base_url()?>ikyp/gostergelerv2/">Göstergeler v2</a>-->
                    ...
                    <!--<a href="<?=base_url()?>ikyp/kademe_ekle">Yeni Kademe Ekle</a>
                    <a href="<?=base_url()?>ikyp/kademe_guncelle">Kademe Güncelle</a>-->
                  </li>

                  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Formlar">
                      <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages12" data-parent="#exampleAccordion2">
                        
                        Formlar
                      </a>
                      <ul class="sidenav-second-level collapse" id="collapseExamplePages12">
                        <li>
                            <a href="<?=base_url()?>ikyp/formlar/">Tüm Formlar</a>
                        </li>

                        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Potansiyel Form Ayarları">
                          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages100" data-parent="#exampleAccordion32">
                            
                          Potansiyel Form Ayarları
                          </a>
                          <ul class="sidenav-second-level collapse" id="collapseExamplePages100">
                            <li>
                              <a href="<?=base_url()?>ikyp/kademe_ekle">Yeni Kademe Ekle</a>
                            </li>
                            <li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Raporlar">
                ...
                <ul class="sidenav-second-level collapse" id="collapseExamplePages4">
                  <li>
                    <a href="<?=base_url()?>raporlar/genel_rapor/">Genel Rapor</a>
                    <a href="<?=base_url()?>atamalar/atama_ekrani/">Atama Ekranı</a>
                  </li>
                </ul>
              </li>
            <?
