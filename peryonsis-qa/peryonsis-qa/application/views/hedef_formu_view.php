 ...
 <?php // Kullanıcı lokasyonunu bulmak
  ...
  <div class="container-fluid">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Bir Önceki Yıl Performans Değerlendirmesi</th>
            <td>
                <?php if($create_button): ?>
                    
                    <a target="_blank" href="<?php echo "/d_donemleri/form_goruntule/".$button_link_items["form_id"]."/".$button_link_items["pernr"]."/".$button_link_items["yil"]."/".$button_link_items["donem"]."/".$button_link_items["ft_id"]."/".$button_link_items["hash"]; ?>" class="btn btn-info">Göz At</a>
                                               ...
                                               foreach ($per_urun[$arr['g_id']][$i] as $key1=>$val1)
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                            <td class="text-center">
                                                                <?=($gd[$arr['g_id']][$i][$val1] == ($kademe_key + 1)) ? 'X':'&nbsp;'?>
                                                            </td>
                                                        <?php
                                                            }
                                                        ?>
                                    ...
                                    else if ($arr['degerlendirme_turu'] == 2) // Objektif
                                    {
                                        ...
                                        else
                                        {
                                          ?>
                                            <tr>
                                                <?php
                                                    foreach($arr["kademeler"] as $kademe_keyx => $kademeler){
                                                ?>

                                              
                                               
                                                <td class="text-center">
                                                    <?=($gd[$arr['g_id']][$i] == ($kademe_keyx + 1)) ? 'X':'&nbsp;'?>
                                                </td>
                                        ...
                                        if ($who == 'yon1')
                                        {
                                            ...
                                            if ($degisiklik)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="radio" name="gd[<?=$arr['g_id']?>][<?=$i?>]" value="<?php echo ($kademe_key + 1 ) ?>" <?=($gd[$arr['g_id']][$i] == ($kademe_key + 1 ))?'checked':''?> <?=$display_per?> required>
                                                    </td>
