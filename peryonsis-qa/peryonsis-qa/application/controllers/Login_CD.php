...
class Login extends CI_Controller {
    ...
    function mail_gonder_CD($subject, $message,$to,$FromName,$cc,$with_pern)
    {
        $ci =& get_instance();
        $ci->load->library('My_email_CD');
       
        if (ENVIRONMENT == 'production'){
            $ci->my_email->sendEmail($subject,$message, $to, 'Performans Sistemi',$cc,$with_pern);
            // $ci->My_email->cc($cc); ?? 
            
        }
        else if (ENVIRONMENT == 'qa'){
            $ci->my_email->sendEmail($subject,$message, 'cisik@santafarma.com.tr', 'santafarma.net');
        }
    ...
    public function new_password_pernr()
    {
