...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Süper Şifre Değiştir</li>
    </ol>
    ...
    <div class="alert alert-info">
        Belirleyeceğiniz şifre ile tüm kullanıcılar gibi sisteme giriş yapabilirsiniz.
    </div>
    
    <div class="card">
        <div class="card-header">
            Süper Şifre Değiştir
        </div>
        <div class="card-body">
            <form method="POST" action="<?=base_url()?>home/sdegistir_k_ss/" id="login">
