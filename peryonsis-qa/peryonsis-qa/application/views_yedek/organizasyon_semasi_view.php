            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?=base_url()?>ikyp/havuz_ata/"  autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="">Kademelendirecek Kişi *</label>
                            <select class="js-example-theme-single form-control" name="dagilim_anahtari" style="width: 100%;">
                                <option value="">Anahtar Yok</option>
                                <?
                                foreach ($havuz_performans_duzeyleri as $duzey)
                                {
                                    ?>
                                    <option value="<?=$duzey->id?>"><?=$duzey->name?></option>      
                                    <?
                                }
                                ?>
                            </select>  
