...
public class StagingManagementApprovalController(ILogger<StagingManagementApprovalController> logger, IMediator mediator, IRedisCacheService redisCacheService) : Controller
{
